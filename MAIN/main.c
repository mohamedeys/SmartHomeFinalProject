 ...
 * MUG.c
 *
 * Created: 21-May-20 11:44:31 PM
 * Author : Mohamed Sakran.
 */ 
...
{	
	...
	// Original password.
	uint8 current_password[6] = {'1', '2', '3', '4', '5', '6'};
		
	// Calender settings sent.
	uint8 calender_frame[7];
	
	// Pointer to  Receive temperature from sensor ECU.
	uint8* ptr_frame;
